...
CREATE TABLE ANIMAL(ANIMAL_ID BIGINT PRIMARY KEY, NICK_NAME VARCHAR(255), WEIGHT DOUBLE, BREED_ID BIGINT, ANIMAL_PLACE VARCHAR(255), PHOTO BLOB, foreign key (BREED_ID) references breed(BREED_ID));
